...
class CustomImage():
    ...
    def fourier_transform_image(self):
        fourier_transformed_image = np.fft.fft2(self.original_image[2])
        shifted_fourier_transformed_iamge = np.fft.fftshift(fourier_transformed_image)
        self.original_image_fourier_components = shifted_fourier_transformed_iamge
